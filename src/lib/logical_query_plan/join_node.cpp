...
UniqueColumnCombinations JoinNode::_output_unique_column_combinations(
  ...
  const auto left_operand_is_unique =
      ...
      get_matching_unique_column_combination(left_unique_column_combinations, {join_predicate->left_operand()}).has_value();
  const auto right_operand_is_unique =
      !right_unique_column_combinations.empty() &&
      get_matching_unique_column_combination(right_unique_column_combinations, {join_predicate->right_operand()}).has_value();
